...
import { MapPin, Briefcase, Star, FileText, Video, ChevronDown } from "lucide-react";
...
// ── Pipeline stages (imported/defined for dropdown population) ─────────────────────────────
const STAGES = [
...
const CandidateCard = ({ candidate, onDragStart, onStatusChange, stagesConfig = STAGES }) => {
  const score =
